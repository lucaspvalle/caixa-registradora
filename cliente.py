...
class Caixa():
    def __init__ (self):
        ...
        cursor = cnx.cursor()
        cursor.execute ("CREATE TABLE if not exists estoque (produto text, qtdade real, valor real, codigo integer)")
        cnx.commit()
    ...
    def resumoItens (self):
        ...
        for produto, qtdade, valor,codigo in self.cursor.fetchall():
    ...
    def resumoBaixoEst (self):
        ...
        for produto, qtdade in self.cursor.fetchall():
...
operacao = int (input ("1 para Entrada \n2 para Atualização do Valor de Venda \
                       \n3 para Vendas \n4 para Relatório de Itens\n5 para Relatório de Baixo Estoque\n6 para Sair\n"))
